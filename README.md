...
<li>Markdownの編集画面で<code><div><video controls src="<!---動画のURL--->" muted="false"></video></div></code>を入力する。</li>
...
<li>Put in <code><div><video controls src="<!---video URL--->" muted="false"></video></div></code> on Markdown edit window.</li>
